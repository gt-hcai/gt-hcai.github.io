---
title: "Workshop on Human-Centred AI (HCAI)"
...
This workshop will be held in **hybrid format**, welcoming participants both:

- **In person** at the Institute for Institute for Intelligent Systems and Robotics (ISIR), Sorbonne Université, Paris ([see access map below](#access))
- **Online via Zoom**, for those unable to travel ([Zoom link](https://cnrs.zoom.us/j/91521880919?pwd=ZWGTVV3CrRCWakwqBKs9gvGbN0Pqq5.1))
...
| Jules Leguy | "A protocol to study the impact of explainable AI on AI-assisted decision making" |
| Lenny Martinez | "From Documentary Practice to Representational Agency: Understanding How Generative AI Reshapes Photography" |
| Linghao Zeng | "Causal Machine Learning for Human Motion Analysis: From Observability to Inference, Prediction to Causation, and Knowledge to Action" |
...
<iframe src="https://docs.google.com/presentation/d/1H2sVAIWUi3SJ5aVHdrWcWDxriysKXjYH72fcciK7Qu4/embed?start=false&loop=false&delayms=3000" width="120%" height="500px" frameborder="0" allowfullscreen></iframe>
